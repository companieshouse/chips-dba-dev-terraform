resource "aws_security_group" "dba_dev_ora12" {
...
resource "aws_vpc_security_group_ingress_rule" "dba_dev_ora12_admin_ssh" {
...
resource "aws_vpc_security_group_ingress_rule" "dba_dev_ora12_ssh" {
...
resource "aws_vpc_security_group_egress_rule" "dba_dev_ora12_all_out" {
